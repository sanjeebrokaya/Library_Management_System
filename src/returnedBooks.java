...
public class returnedBooks extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbl_returnedbooks.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Book ID", "Book Name", "Pubisher", "Student ID", "Student Name", "Course", "Year", "Semester", "Date of Issue", "Date of Return"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            model.setRowCount(0);
            while(rs.next()){
                model.addRow(new String[]{rs.getString(1),rs.getString(2),rs.getString(4),rs.getString(6),rs.getString(7)
